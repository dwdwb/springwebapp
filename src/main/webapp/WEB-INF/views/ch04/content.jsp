         ...
         <div class="card-body">
            <form id="form2" name="form2" action="method2">
               ...
               <div class="input-group">
	            ...
	            <div class="mt-2">
	               <button class="btn btn-info btn-sm" type="submit">POST 방식 요청</button>
	            </div>
            </form>
         </div>
      </div>
      ...
      <div class="card m-2">
         ...
         <div class="card-body">
            <div class="card m-2">
               ...
               <div class="card-body">         
                  <form id="form3" name="form3" method="post" action="join">
                     <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text">mid</span></div>
                        <input type="text" name="mid" class="form-control" value="${ch04JoinForm.mid}" autocomplete="username">
                        <form:errors cssClass="text-danger" path="ch04JoinForm.mid"/>
                     </div>
                     <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text">mpassword</span></div>
                        <input type="password" name="mpassword" class="form-control" value="${ch04JoinForm.mpassword}" autocomplete="current-password">
                        <form:errors cssClass="text-danger" path="ch04JoinForm.mpassword"/>
                     </div>
                     <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text">memail</span></div>
                        <input type="text" name="memail" class="form-control" value="${ch04JoinForm.memail}">
                        <form:errors cssClass="text-danger" path="ch04JoinForm.memail"/>
                     </div>
                     <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text">mtel</span></div>
                        <input type="text" name="mtel" class="form-control" value="${ch04JoinForm.mtel}">
                        <form:errors cssClass="text-danger" path="ch04JoinForm.mtel"/>
                     </div>
            ...
            <div class="card m-2">
               ...
               <div class="card-body">
                  <form id="form4" name="form4" method="post" action="login">
                     <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text">mid</span></div>
                        <input type="text" name="mid" class="form-control" value="${ch04LoginForm.mid}">
                        <form:errors cssClass="text-danger" path="ch04LoginForm.mid"/>
                     </div>
                     <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text">mpassword</span></div>
                        <input type="password" name="mpassword" class="form-control" value="${ch04LoginForm.mpassword}">
                        <form:errors cssClass="text-danger" path="ch04LoginForm.mpassword"/>
                     </div>
